...
! function(t) {
    ...
    be.mixin({
        ...
        handleSegMouseover: function(t, e) {
            we.get().shouldIgnoreMouse() || this.mousedOverSeg || (this.mousedOverSeg = t, this.view.isEventResizable(t.event) && t.el.addClass(), this.view.publiclyTrigger("eventMouseover", t.el[0], t.event, e))
        },
        handleSegMouseout: function(t, e) {
            e = e || {}, this.mousedOverSeg && (t = t || this.mousedOverSeg, this.mousedOverSeg = null, this.view.isEventResizable(t.event) && t.el.removeClass(), this.view.publiclyTrigger("eventMouseout", t.el[0], t.event, e))
        },
        ...
        getSegClasses: function(t, e, n) {
            var i = this.view,
                r = [t.isStart ? "" : "fc-not-start", t.isEnd ? "" : "fc-not-end"].concat(this.getSegCustomClasses(t));
            return e && r.push(), n && r.push("fc-resizable"), i.isEventSelected(t.event) && r.push("fc-selected"), r
        },
    ...
    De.mixin({
        ...
        fgSegHtml: function(t, e) {
            var n, i, r = this.view,
                ...
                c = "";
            return u.unshift(""), t.isStart && (n = this.getEventTimeText(s)) && (c = '<span>' + ht(n) + "</span>"), i = '<span>' + (ht(s.title || "") || "&nbsp;") + "</span>", '<a class="' + u.join(" ") + '"' + (s.url ? ' href="' + ht(s.url) + '"' : "") + (h ? ' style="' + h + '"' : "") + '>' + (this.isRTL ? i + " " + c : c + " " + i) + "</div>" + (a ? '<div class="fc-resizer fc-start-resizer" />' : "") + (l ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
        ...
        renderSegPopoverContent: function(e, n, i) {
            var r, s = this.view,
                ...
                l = t('<div class="fc-header ' + s.widgetHeaderClass + '"><span class="fc-close ' + (o ? "ui-icon ui-icon-closethick" : "fc-icon fc-icon-x") + '"></span><span>' + ht(a) + '</span><div class="fc-clear"/></div><div class="fc-body ' + s.widgetContentClass + '"><div class="fc-event-container"></div></div>'),
    ...
    Te.mixin({
        ...
        fgSegHtml: function(t, e) {
            ...
            return h.unshift("fc-time-grid-event", "fc-v-event"), s.isMultiDayEvent(o) ? (t.isStart || t.isEnd) && (n = this.getEventTimeText(t), i = this.getEventTimeText(t, "LT"), r = this.getEventTimeText(t, null, !1)) : (n = this.getEventTimeText(o), i = this.getEventTimeText(o, "LT"), r = this.getEventTimeText(o, null, !1)), '<a class="' + h.join(" ") + '"' + (o.url ? ' href="' + ht(o.url) + '"' : "") + (c ? ' style="' + c + '"' : "") + '>' + (n ? '<div class="" data-start="' + ht(r) + '" data-full="' + ht(i) + '"><span>' + ht(n) + "</span></div>" : "") + (o.title ? '<div>' + ht(o.title) + "</div>" : "") + '</div><div class="fc-bg"/>' + (u ? '<div class="fc-resizer fc-end-resizer" />' : "") + "</a>"
        },
